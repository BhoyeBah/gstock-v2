...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('customer_credit_notes', function (Blueprint $table) {
            ...
            $table->uuid('customer_return_id')->unique();
            $table->uuid('customer_invoice_id')->nullable()->index();
        ...
        Schema::create('customer_credit_note_items', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('tenant_id')->index();
            $table->uuid('customer_credit_note_id')->index();
            $table->uuid('customer_return_item_id')->nullable()->index();
            ...
            $table->foreign('tenant_id')->references('id')->on('tenants')->onDelete('cascade');
            $table->foreign('customer_credit_note_id')->references('id')->on('customer_credit_notes')->onDelete('cascade');
            $table->foreign('customer_return_item_id')->references('id')->on('customer_return_items')->nullOnDelete();
