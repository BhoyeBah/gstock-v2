...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .expense-page { width: 210mm; min-height: 297mm; background: white; padding: 15mm; box-shadow: 0 0 10px rgba(0,0,0,0.1); position: relative; }
        ...
        .report-title h2 { font-size: 22pt; font-weight: bold; margin-bottom: 1mm; color: #000; }
        .report-type { font-size: 10pt; color: #666; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px; }
        .info-section { display: flex; justify-content: space-between; margin-bottom: 6mm; gap: 5mm; }
        .period-box, .summary-box { flex: 1; }
        ...
        .summary-box .info-content { text-align: right; }
        .expense-table { width: 100%; border-collapse: collapse; margin-bottom: 5mm; font-size: 9pt; border: 1px solid #000; }
        .expense-table th, .expense-table td { border: 1px solid #000; padding: 2.5mm; font-size: 9pt; }
        .expense-table thead { background-color: #000; color: #fff; }
        .expense-table th { font-weight: bold; text-align: left; color: #fff; }
        .expense-table tbody td { color: #000; background-color: #fff; }
        .expense-table tbody tr.empty-row td { color: #ccc; height: 6mm; }
        .expense-table tbody tr:hover { background-color: #f8f8f8; }
        ...
        .total-line.count { border-bottom: 1px solid #ddd; padding-bottom: 2mm; margin-bottom: 2mm; }
        ...
        @media print {
            ...
            .expense-page { box-shadow: none !important; margin: 0 !important; padding: 15mm !important; }
            .print-btn { display: none !important; }
            @page { size: A4 portrait; margin: 0mm !important; }
            .expense-table thead { background-color: #000 !important; color: #fff !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
            .expense-table th { color: #fff !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
            .stat-badge { -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        }
    </style>
</head>
        ...
        <div class="expense-page">
            ...
            <div class="header">
                ...
                <div class="report-title">
                    @if ($tenant && $tenant->logo)
                        <img src="{{ asset('storage/' . $tenant->logo) }}" alt="Logo entreprise" style="max-width: 70px; max-height: 70px; display:block; margin:0 auto 5px;">
                    @else
            ...
            <div class="info-section">
                ...
                <div class="summary-box">
                    ...
                    <div class="info-content">
                        ...
                        <strong>Total des dépenses:</strong> <span class="stat-badge">{{ number_format($totalExpenses, 0, ',', ' ') }} FCFA</span><br>
            ...
            <table class="expense-table">
                <thead>
                    <tr>
                        ...
                        <th style="width: 55%;">Motif / Raison</th>
            ...
            <div class="totals">
                ...
                <div class="total-line">
                    ...
                    <span>{{ count($expenses) > 0 ? number_format($totalExpenses / count($expenses), 0, ',', ' ') : 0 }} FCFA</span>
                </div>
