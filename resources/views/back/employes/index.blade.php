...
@section('content')
        ...
        <div class="card-body p-4">
            <form method="GET" action="{{ route('employes.index') }}">
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        <label for="search_name">Matricule</label>
                        <input type="text" name="matricule" id="matricule" class="form-control"
                            value="{{ request('matricule') }}" placeholder="Ex : EMP-2026-001">
                    </div>
                    <div class="col-md-3 mb-3">
                        ...
                        <tbody>
                            ...
                            --}}
                                    ...
                                    <td class="text-center action-buttons">
                                        <a href="{{ route('employes.show', $employe->id) }}" class="btn btn-sm btn-primary"
                                            title="Voir">
    ...
    {{-- ===================== MODAL: ADD EMPLOYEE ===================== --}}
    <div class="modal fade" id="addEmployeModal" tabindex="-1" role="dialog" aria-labelledby="addEmployeModalLabel"
        aria-hidden="true">
