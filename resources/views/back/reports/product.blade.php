...
@section('content')
    ...
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        <h3 class="m-0">📦 Rapport des Produits Vendus</h3>
        ...
        <form method="GET" action="">
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="date" name="start_date" class="form-control" value="{{ $startDate ?? request('start_date') }}">
                </div>

                <div class="col-md-3">
                    <label>📅 Date fin</label>
                    <input type="date" name="end_date" class="form-control" value="{{ $endDate ?? request('end_date') }}">
                </div>
    ...
    <div id="print-area" class="main-table-card">
        ...
        <div class="row mt-3">
            <div class="col-md-6">
                <h5><strong>Total Quantité Vendue : </strong> {{ number_format($totalQtySold,0,',',' ') }}</h5>
            </div>
            <div class="col-md-6 text-end">
                <h5><strong>Total Recettes : </strong> {{ number_format($totalRevenue,0,',',' ') }} FCFA</h5>
            </div>
        </div>
