    ...
    <div class="container-fluid">
        <div class="page-hero page-hero--accent mb-4">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3">
                <div>
                    <div class="page-hero__eyebrow mb-2">Avoir client</div>
                ...
                <div class="d-flex flex-wrap gap-2">
                    <a href="{{ route('customer-credit-notes.print', $record) }}" class="btn btn-outline-primary">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card table-card mb-4">
                    <div class="card-body">
                        ...
                        @if($record->customerReturn)
                            <div class="alert alert-light border mt-3 mb-0">
                                Retour source {{ $record->customerReturn->return_number }}.
                                @if($record->invoice)
                                    <div class="mt-2">
                ...
                <div class="card table-card">
                    <div class="card-body">
                        ...
                        @if($canRefund)
                            <form action="{{ route('customer-credit-notes.refund', $record) }}" method="POST">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label>Note</label>
                                    <input type="text" name="note" class="form-control" placeholder="Remboursement client">
                                </div>
